...
//     const { title, description, category, duration_hours , instructor, level, price, tags } = req.body;
...
//     if (!title || !description || !category  || !duration_hours || !instructor|| !image , !level || !price ) {
//         return res.status(400).json({ message: "All fields are required." });
//     }


//     // const file = req.files.image;
//     const uploadPath = path.join(__dirname , '../../frontend/public/uploads' , image.name);
